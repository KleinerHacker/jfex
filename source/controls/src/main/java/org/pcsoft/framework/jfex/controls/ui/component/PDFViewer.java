...
public class PDFViewer extends VBox {
    ...
    public PDFViewer() {
        final Fxml.FxmlTuple<PDFViewerView, PDFViewerViewModel> viewTuple =
                Fxml.from(PDFViewerView.class).withRoot(this)
                        .withResources(ResourceBundle.getBundle("lan/text"))
                        .load();
