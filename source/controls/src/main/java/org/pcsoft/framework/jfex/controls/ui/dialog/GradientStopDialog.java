...
public class GradientStopDialog extends Dialog<GradientStopDialog.Data> {
    ...
    public GradientStopDialog(final Window owner, final Data data) {
        ...
        final Fxml.FxmlTuple<GradientStopDialogView, GradientStopDialogViewModel> viewTuple =
                Fxml.from(GradientStopDialogView.class).withResources(resourceBundle).load();
