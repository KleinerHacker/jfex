...
public class FileChooserPane extends HBox {
    ...
    public FileChooserPane() {
        final ViewTuple<FileChooserPaneView, FileChooserPaneViewModel> viewTuple =
                FluentViewLoader.fxmlView(FileChooserPaneView.class).resourceBundle(ResourceBundle.getBundle("lan/text")).root(this).load();
