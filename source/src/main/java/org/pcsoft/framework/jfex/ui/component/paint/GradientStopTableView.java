...
import org.pcsoft.framework.jfex.ui.dialog.GradientStopDialog;
...
public class GradientStopTableView implements FxmlView<GradientStopTableViewModel>, Initializable {
    @FXML
    ...
    @InjectViewModel
    private GradientStopTableViewModel viewModel;
