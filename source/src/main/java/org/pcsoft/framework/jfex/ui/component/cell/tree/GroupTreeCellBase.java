...
import org.pcsoft.framework.jfex.ui.component.GroupComboBox;
import org.pcsoft.framework.jfex.ui.component.cell.CellPane;


public abstract class GroupTreeCellBase<T, G extends Comparable<G>, PT extends Node & CellPane<T>, PG extends Node & CellPane<G>> extends TreeCell<GroupComboBox.Item> {
    protected final PT typePane;
    protected final PG groupPane;

    public GroupTreeCellBase(Class<PT> typePaneClass, Class<PG> groupPaneClass) {
        try {
