...
public class ImageTreeTableCell<S, T> extends TreeTableCell<S, T> {
    ...
    public ImageTreeTableCell(final Function<T, Image> imageFunction, final boolean showImageIfNull) {
        this.imageFunction.set(imageFunction);
        this.showImageIfNull.set(showImageIfNull);
    }

    public ImageTreeTableCell(final Function<T, Image> imageFunction) {
        this.imageFunction.set(imageFunction);
    }

    public ImageTreeTableCell(final Image image, final boolean showImageIfNull) {
        this.imageFunction.set(o -> image);
        this.showImageIfNull.set(showImageIfNull);
    }

    public ImageTreeTableCell(final Image image) {
        this.imageFunction.set(o -> image);
    }
