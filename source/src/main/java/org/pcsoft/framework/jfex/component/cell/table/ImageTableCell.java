...
public class ImageTableCell<S, T> extends TableCell<S, T> {
    ...
    public ImageTableCell(final Function<T, Image> imageFunction, final boolean showImageIfNull) {
        this.imageFunction.set(imageFunction);
        this.showImageIfNull.set(showImageIfNull);
    }

    public ImageTableCell(final Function<T, Image> imageFunction) {
        this.imageFunction.set(imageFunction);
    }

    public ImageTableCell(final Image image, final boolean showImageIfNull) {
        this.imageFunction.set(o -> image);
        this.showImageIfNull.set(showImageIfNull);
    }

    public ImageTableCell(final Image image) {
        this.imageFunction.set(o -> image);
    }
